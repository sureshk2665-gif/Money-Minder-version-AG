...
class BackupPreferences(context: Context) {
    ...
    var customClientSecret: String
        get() = encryptedPrefs.getString(KEY_CUSTOM_CLIENT_SECRET, "") ?: ""
        set(value) = encryptedPrefs.edit().putString(KEY_CUSTOM_CLIENT_SECRET, value).apply()
    ...
    companion object {
        ...
        private const val KEY_CUSTOM_CLIENT_SECRET = "custom_client_secret"
